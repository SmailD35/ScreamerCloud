...
public:
    ...
    bool Register(const std::string &login, const std::string &password, DbErrorCodes &error);

    bool Authorize(const std::string &login, const std::string &password, DbErrorCodes &error);
    ...
    bool Upload(const std::string &file_name, const std::string &dir_name, const std::string &hash_sum, DbErrorCodes &error) ;
    ...
    std::shared_ptr<InFile> Download(const std::string &file_name, const std::string &dir_name, DbErrorCodes &error);
    ...
    std::shared_ptr<InFile> DownloadByLink(const std::string &link, DbErrorCodes &error);
};
